...
static
PCEVENT_ITEM SpeakerControlChangeEvents[] =
{
  {
...
DEFINE_PCAUTOMATION_TABLE_PROP_EVENT(
    ...
    SpeakerPropertiesVolume,
    SpeakerControlChangeEvents);
...
static
PCEVENT_ITEM SpeakerJackInfoChangeEvents[] =
{
  {
...
DEFINE_PCAUTOMATION_TABLE_PROP_EVENT(
    AutomationSpeakerTopoFilterWithEvent,
    PropertiesSpeakerTopoFilter,
    SpeakerJackInfoChangeEvents);
...
{
  0,                                            // Version
  &AutomationSpeakerTopoFilterWithEvent,        // AutomationTable
