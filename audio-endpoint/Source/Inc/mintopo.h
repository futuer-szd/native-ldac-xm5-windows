...
public:
    ...
    NTSTATUS EventHandlerJackInfoChange
    (
        _In_        PPCEVENT_REQUEST                            EventRequest
    );

    VOID GenerateJackInfoChange();

    NTSTATUS EventHandlerControlChange
    (
        _In_        PPCEVENT_REQUEST                            EventRequest
    );

    VOID GenerateControlChange
    (
        _In_        ULONG                                       NodeId
    );

    BOOL NativeLdacIsJackConnected();
