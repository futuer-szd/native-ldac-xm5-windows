...
// Product Id
// {B5D79032-6B58-403A-9475-008A65FE461C}
#define STATIC_PID_SIMPLEAUDIOSAMPLE\
    0xb5d79032, 0x6b58, 0x403a, 0x94, 0x75, 0x00, 0x8a, 0x65, 0xfe, 0x46, 0x1c
DEFINE_GUIDSTRUCT("B5D79032-6B58-403A-9475-008A65FE461C", PID_SIMPLEAUDIOSAMPLE);
...
// The endpoint implements its hardware volume in the user-mode bridge.  A
// coarse 0.5 dB topology step can collapse adjacent Windows media-key volume
// steps to the same stored value, producing a visible +0/-0 change.  Expose a
// 1/32 dB step so VolumeStepUp/VolumeStepDown always have sufficient
// resolution while the existing -96..0 dB range remains unchanged.
